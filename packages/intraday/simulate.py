...
def run_intraday_simulate(*, on_date: date | None = None) -> dict:
    ...
    save_watch_manifest(
        outcome="ok",
        on_date=day,
        auction_point_count=int(auction_result.get("point_count") or 0),
        ...
        message="simulate",
        phases_done=["auction", "morning", "afternoon"],
    )
    ...
    return {
        ...
        "auction_point_count": auction_result.get("point_count"),
        "morning_point_count": len(morning_points),
        "afternoon_point_count": len(afternoon_points),
        "merged_point_count": len(morning_points) + len(afternoon_points),
        "stock_count": len(stocks),
        "interval_sec": interval,
        "auction_trend_path": auction_result.get("trend_path"),
        ...
        "auction_series_path": f"data/auction_series_{day_iso}.json",
